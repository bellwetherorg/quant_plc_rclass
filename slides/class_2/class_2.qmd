...
## You will be receiving an email with an invitation to join the GitHub organization for this training

## Once you click the green button, you will be directed to join the organization 

## Bookmark the organization page - your homework assignments will show up here as repositories. 

## To start an assignment, navigate to the repository and copy the HTTPS link that apreas when you click the "Code" button 

## Next, you'll open RStudio and create a new project, seelcting the "Version control" and "Git" options 
...
-  Coding task: In your homework repository, there is a raw data file that you will clean 
