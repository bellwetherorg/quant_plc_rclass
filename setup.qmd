...
**Git** is an Open Source Distributed Version Control System, meaning it helps with tracking content, version control, and sharing information. Instructions on how to download Git can be found [here](https://github.com/git-guides/install-git).
