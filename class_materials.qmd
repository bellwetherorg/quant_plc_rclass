...
-   **Homework:** There are two homework scripts in the `/scripts` folder. **Homework is due by COB on Tuesday, July 16**. Please commit and then push your homework updates using Git to update the repository. 
