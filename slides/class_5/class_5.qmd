...
-   Homework will be distributed in `hw-wk-6` repository where you will practice summarizing data 
-   Come to class on July 23 with between 2-3 data frames. Krista will show you all how to create a repository so you can do your own data cleaning, analysizis, and visualization on a project.
