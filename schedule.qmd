...
All R classes will take place from 11:00 AM - 12:00 PM Central Time. We will also be recording the R classes in case someone is unable to attend. Krista will host weekly office hours to provide R support and answer questions.

|          |                |                                                                 |
|:------------------|:-----------------:|:----------------------------------|
| **Week** | **Class Date** | **Description**                                                 |
| [Week1](https://https://bellwetherorg.github.io/quant_plc_rclass/classes/class_1.html)   |    March 19    | Introduction to R, RStudio, Git, and GitHub                     |
